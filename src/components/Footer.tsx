      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3 text-white/90">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-white">Call us: <span className="font-semibold">329 456 7890</span></span>
              </div>
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm text-white">
                  <div>329 Queensberry Street, North Melbourne VIC</div>
                  <div>3051, Australia</div>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-5 h-5 bg-white/20 rounded-full flex items-center justify-center">
        ...
        <div className="border-t border-white/20 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            <a href="#" className="w-8 h-8 bg-white/20 rounded-lg shadow-sm border border-white/30 flex items-center justify-center hover:bg-white hover:text-[#1B4696] hover:shadow-lg transition-all duration-300 group">
              <svg className="w-4 h-4 text-white group-hover:text-[#1B4696]" fill="currentColor" viewBox="0 0 24 24">
